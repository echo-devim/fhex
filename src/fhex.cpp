    ...
    : QMainWindow(parent)
{
    ...
    **/
    ...
    // Default is half of screen size & centered on screen
...
void Fhex::on_menu_open_patterns_click() {
    ...
    if (patternsPath != "") {
        ...
        /*
         * RELOAD FILE WITH PATTERNS FILE,
...
void Fhex::findPatterns() {
    ...
    for (Match *m : matches) {
         ...
         * TO SHOW PATTERS IF THEY FIT ON SCREEN
         */
